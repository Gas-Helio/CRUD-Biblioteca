...
class Ui_Tela_Principal(object):
    def setupUi(self, Tela_Principal):
        ...
        self.label.setGeometry(QtCore.QRect(320, 90, 241, 41))
        font = QtGui.QFont()
        ...
        self.ver_acervo.setGeometry(QtCore.QRect(300, 330, 291, 81))
        font = QtGui.QFont()
        font.setFamily("Lucida Sans Unicode")
        font.setPointSize(9)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(200, 30, 511, 451))
        self.textBrowser.setObjectName("textBrowser")
        self.cadastrar_novo_livro = QtWidgets.QPushButton(self.centralwidget)
        self.cadastrar_novo_livro.setGeometry(QtCore.QRect(300, 240, 291, 81))
        font = QtGui.QFont()
        font.setFamily("Lucida Sans Unicode")
        font.setPointSize(9)
        ...
        self.sair.setGeometry(QtCore.QRect(610, 100, 93, 28))
        font = QtGui.QFont()
        font.setFamily("Lucida Sans Unicode")
        font.setPointSize(9)
    ...
    def retranslateUi(self, Tela_Principal):
        ...
        self.label.setText(_translate("Tela_Principal", "Olá,"))
